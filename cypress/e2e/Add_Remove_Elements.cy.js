//Test Case 1//
//import { add_remove_elemens, add_remove_elements } from "../Pages/Add_Remove_Elements";

describe('Add_Remove_Elments', () => {
  it('Verify rhe functionality of Add_Remove_Elments', () => {
    cy.visit('https://the-internet.herokuapp.com')
    cy.contains(add_remove_elements.NAMES.contentText).click();
    cy.url().should('include',add_remove_elements.NAMES.addRemoveLink),
